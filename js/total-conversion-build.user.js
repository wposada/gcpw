...
window.MAX_IDLE_TIME = 1500*60; // stop updating map after 15min idling
...
//    if (systemNarrowcast && !isPublicChannel) return true;
    ...
    var msg = '', nick = '',poslat = '',poslon ='';
      ...
      case 'PORTAL':
        ...
        msg += 'lat="'+latlng[0]+'"'
          + ' long="'+latlng[1]+'"'
          + ' name="'+window.chat.getChatPortalName(markup[1])+'"';
               plat=latlng[0];
        break;
...
//    if ((!isPublicChannel) && (!isSecureMessage)) return true;
    ...
    storageHash.data[json[0]] = [json[1], auto, chat.renderMsg(msg, nick, time, team, msgToPlayer, systemNarrowcast,poslat,poslon), nick];  
...
window.chat.renderMsg = function(msg, nick, time, team, msgToPlayer, systemNarrowcast,poslat,poslon) {
...
//wiil modify
var REFRESH_ITERACION=true;
var TIMES_ITERACION=800000;


//function devolver
if(REFRESH_ITERACION){
var contador=TIMES_ITERACION;

function restar(){
     contador=contador-1;
    $( "div#chatall" ).scrollTop( 100 );
     $( "div#chatall" ).scrollTop( -200 );
...
function acabarCuentaAtras(){
    ...
    window.open('www.ingress.com/intel','_blank');
    var objWindow = window.open(location.href, "_self");
     objWindow.close();
	
}
var temporizador=setInterval(function(){restar()},5000); // 10000ms = 10s
